/*!
  ...
  Languages: Bash, C#, CSS, Diff, HTML,XML, JSON, JavaScript, Markdown, PHP, 
    Perl, Plain text, Python, Python REPL, SCSS, SQL, Shell Session, Swift, 
    TypeScript
 */
...
;hljs.registerLanguage("python-repl",a)})();/*! `perl` grammar compiled for Highlight.js 11.7.0 */
(()=>{var e=(()=>{"use strict";return e=>{
...
},...B,..._,...M,I,P,...z,...q,U,V]}}})();hljs.registerLanguage("swift",e)})();/*! `markdown` grammar compiled for Highlight.js 11.7.0 */
...
;hljs.registerLanguage("markdown",e)})();/*! `shell` grammar compiled for Highlight.js 11.7.0 */
