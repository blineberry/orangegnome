...
from .models import Syndication, TwitterUser, MastodonStatus, MastodonSyndicatable, MastodonStatusesToProcess, MastodonNotification
...
admin.site.register(MastodonNotification)