...
urlpatterns = [
    ...
    path('posts/<int:pk>', views.PostDetailView.as_view(), {"wm_app_name": 'feed', "wm_model_name": "Post"}, name="detail"),
    path('posts/<int:pk>/<slug:slug>', views.PostDetailView.as_view(), {"wm_app_name": 'feed', "wm_model_name": "Post"}, name="detail"),
    ...
    path('images/', views.ImageIndexView.as_view(), name='images'),
